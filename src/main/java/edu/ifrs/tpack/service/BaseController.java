...
public class BaseController {
    @Inject
    protected DAOSession daoSession;//comment
    @Inject
    protected DAOSubject daoSubject;//comment
    @Inject
    protected DAOQuestion daoQuestion;//comment
    @Inject
    protected DAOAnswer daoAnswer;//comment
    @Inject
    protected DAOChoice daoChoice;//comment
}
